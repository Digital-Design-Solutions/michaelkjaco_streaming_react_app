  ...
  const ScheduleCard = (eventDate, isActive) => {
    ...
    return (
      ...
      >
        ...
        {/* live info */}
        <Box style={{ flex: 1.5, display: "flex", flexDirection: "column" }}>
          <img src={LocalImages.liveTv} alt="live_tv" className="live-icon" />
          <h1
            style={{
              fontWeight: "400",
        ...
        >
          ...
          {/* <IonIcon icon={chatboxEllipsesOutline} size="large" style={{ marginTop: "8px" }}></IonIcon> */}
